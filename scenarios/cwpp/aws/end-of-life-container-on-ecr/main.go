...
func main() {
    pulumi.Run(func(ctx *pulumi.Context) error {
        ...
        _, err = docker.NewImage(ctx, "end_of_life_ubuntu2110", &docker.ImageArgs{
            Build: &docker.DockerBuildArgs{
                Context: pulumi.String("."),
            },
            ImageName: pulumi.Sprintf("%s:%s", repo.RepositoryUrl, "end_of_life_ubuntu2110"),
        ...
        fmt.Println("repositoryUrl", repo.RepositoryUrl)
