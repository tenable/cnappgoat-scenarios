...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		sudo docker run --name vulnerable_tomcat_container -d -p 80:80 public.ecr.aws/i3j2g7c0/cnappgoat-images:tomcat_image
		`
    ...
    // Get the latest AMI
		...
		_, err = ec2.NewInstance(ctx, "CnappgoatCWPPVulnerableTomcatContainerOnEC2", &ec2.InstanceArgs{
			Ami:                      pulumi.String(amiResult.Id), 
			InstanceType:             pulumi.String("t3.micro"),
			VpcSecurityGroupIds:      pulumi.StringArray{group.ID()},
			UserData:                 pulumi.String(userData),
			AssociatePublicIpAddress: pulumi.Bool(true),
			Tags:                     pulumi.StringMap{"Name": pulumi.String("CnappgoatCWPPVulnerableTomcatContainerOnEC2")},
		}, pulumi.Provider(awsProvider))
		if err != nil {
			return err
		}
