...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		sudo docker run --name vulnerable_jenkins_container -d -p 80:80 public.ecr.aws/i3j2g7c0/cnappgoat-images:jenkins_image
		`
		...
		_, err = ec2.NewInstance(ctx, "CnappgoatCWPPVulnerableJenkinsContainerOnEC2", &ec2.InstanceArgs{
			Ami:                      pulumi.String(amiResult.Id), 
			InstanceType:             pulumi.String("t3.micro"),
			VpcSecurityGroupIds:      pulumi.StringArray{group.ID()},
			UserData:                 pulumi.String(userData),
			AssociatePublicIpAddress: pulumi.Bool(true),
			Tags:                     pulumi.StringMap{"Name": pulumi.String("CnappgoatCWPPVulnerableJenkinsContainerOnEC2")},
		}, pulumi.Provider(awsProvider))
		if err != nil {
			return err
		}
