module cspm-azure-vm-open-public

go 1.20

require (
	github.com/pulumi/pulumi-azure-native-sdk/compute/v2 v2.7.0
...
require (
	...
	github.com/pulumi/pulumi-azure-native-sdk/v2 v2.7.0 // indirect
