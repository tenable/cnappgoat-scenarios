...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		ctx.Export("CNAPPgoat-vm-unrestricted-ssh-vnet", vnet.Name)
		ctx.Export("CNAPPgoat-vm-unrestricted-ssh-subnet", subnet.Name)
		ctx.Export("CNAPPgoat-vm-unrestricted-ssh-nsg", nsg.Name)
		ctx.Export("CNAPPgoat-vm-unrestricted-ssh-instance", vm.Name)
		ctx.Export("CNAPPgoat-vm-unrestricted-ssh-password", password.Result)
		return nil
	})
}
