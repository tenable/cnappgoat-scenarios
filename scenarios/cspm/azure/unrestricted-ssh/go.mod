module cspm-azure-unrestricted-ssh

go 1.20

require (
	github.com/pulumi/pulumi-azure-native-sdk/compute/v2 v2.8.0
	github.com/pulumi/pulumi-azure-native-sdk/network/v2 v2.7.0
	github.com/pulumi/pulumi-azure-native-sdk/resources/v2 v2.7.0
