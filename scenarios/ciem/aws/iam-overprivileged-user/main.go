...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		// Attach the S3 full access policy to the user
		_, err = iam.NewUserPolicyAttachment(ctx, "CNAPPGoatOverprivilegedUserS3FullAccess", &iam.UserPolicyAttachmentArgs{
